...
function Portfolio(){
    return(
        ...
        <section className="absolute w-full min-h-[100svh] top-60 md:top-50 md:top-50 left-0 z-50 p-2">
            <div className="flex flex-col w-auto items-center justify-center overflow-hidden z-50 gap-4 text-white text-shadow-lg/30">
                ...
                <img className="w-90 md: w-100 md:h-80 h-55 rounded-md shadow-lg" src={Fundo} alt="fundo do próprio site" />
